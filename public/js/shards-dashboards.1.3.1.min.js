!(function (e, t) {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(this.value))
                                return (
                                    3 ==
                                        (e = this.value.substring(1).split(""))
                                            .length &&
                                        (e = [
                                            e[0],
                                            e[0],
    ...
    if (0 !== Object.keys(b).length && b.constructor === Object)
        for (var y in b)
            if (b.hasOwnProperty(y)) {
                if (!/^#([A-Fa-f0-9]{3}$)|([A-Fa-f0-9]{6}$)/.test(b[y]))
                    throw new Error(
                        "Please provide a hexadecimal color value if you are trying to override the Shards Dashboards colors."
                    );
    ...
    if ("undefined" == typeof Chart)
        throw new Error(
            "Shards Dashboards requires the Chart.js library in order to work properly."
        );
    (window.ShardsDashboards = window.ShardsDashboards
        ? window.ShardsDashboards
        : {}),
        (window.ShardsDashboards.colors = w),
        $.extend($.easing, {
        ...
        (Chart.defaults.scale.ticks.autoSkip = !1),
        (Chart.defaults.scale.ticks.minRotation = 0),
        (Chart.defaults.scale.ticks.maxRotation = 0),
        (Chart.defaults.scale.ticks.padding = 10),
        (Chart.defaults.global.elements.point.backgroundColor = w.white.toHex()),
        (Chart.defaults.global.elements.point.radius = 4),
        (Chart.defaults.global.elements.point.hoverRadius = 5),
        (Chart.defaults.global.tooltips.custom = function (e) {
            var t = document.getElementsByClassName(
                "sc-tooltip-" + this._chart.id
            )[0];
            if (
                (t ||
                    ...
                    this._chart.canvas.parentNode.appendChild(t)),
                0 !== e.opacity)
            ) {
                if (
                    ...
                    a.forEach(function (e) {
                        ...
                        r.forEach(function (t, a) {
                            ...
                            (o += "; border-color:" + r.borderColor),
                                (n += "<tr><td>"
                                    .concat(
                                        '<span class="sc-tooltip-key" style="' +
                                            (o += "; border-width: 2px") +
                                            '"></span>',
                                        " "
                                    )
                        ...
                        (n += "</tbody>"),
                        (t.querySelector("table").innerHTML = n);
                }
                var o = this._chart.canvas.offsetTop,
                    s = this._chart.canvas.offsetLeft;
                (t.style.opacity = 1),
                    (t.style.left = s + e.caretX + "px"),
                    (t.style.top = o + e.caretY + "px");
            } else t.style.opacity = 0;
        }),
        (Chart.defaults.global.legendCallback = function (e) {
            var t = '<ul class="sc-legend-container sc-legend-chart-'.concat(
                e.id,
                '">'
            );
            return (
                e.data.datasets.map(function (e) {
                    t += '<li class="sc-legend"><span class="sc-legend__label" style="background: '
                        .concat(e.borderColor, ' !important;"></span>')
                        .concat(e.label ? e.label : "", "</li>");
                }),
                (t += "</ul>")
            );
        }),
