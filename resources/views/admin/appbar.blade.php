        ...
        <div class="color-switcher animated">
            ...
            <div class="social-wrapper">
                <div class="social-actions">
                    ...
                    <div class="inner-wrapper">
                        <a class="github-button"
                            ...
                            aria-label="Star DesignRevision/shards-dashboard on
                            GitHub">Star</a>
                ...
                <div id="social-share"
                    ...
                    data-text="🔥 Check out Shards Dashboard Lite, a free and
                    beautiful
                        ...
                        <ul class="nav nav--no-borders flex-column">
                            <li class="nav-item">
                                <a class='nav-link active'
                                    href="{{route('showContent', ['page'=> 'inicio'] )}}">
                                    ...
                                    <div class="dropdown-menu
                                        ...
                                        <a class="dropdown-item" href="#">
                                            ...
                                            <div class="notification__content">
                                                <span
                                                    class="notification__category">Analytics</span>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            ...
                                            <div class="notification__content">
                                                <span
                                                    class="notification__category">Sales</span>
